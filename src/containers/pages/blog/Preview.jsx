        ...
        <div className="flex flex-col items-center justify-center pt-36  px-16 dark:text-gray-300 bg-neutral-100 dark:bg-neutral-950 transition-all duration-300 ease-in-out ">
          <div className="  w-full line-clamp-4 max-w-5xl z-20 pb-16 ">
            ...
            <div className="flex flex-col ">
              ...
              <div className="w-full h-1 rounded-full bg-black dark:bg-white mb-10"></div>
              {post.content !== null && (
                <div className=" prose w-full h-auto flex flex-col justify-center max-w-full  px-10 prose-p:text-neutral-800 dark:prose-p:text-neutral-200 prose-li:text-neutral-900 dark:prose-li:text-slate-100 text-black dark:text-white dark:prose-strong:text-white dark:prose-h1:text-gray-200 dark:prose-h2:text-gray-400 dark:prose-h3:text-neutral-300 ">
                  <p
